...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!mapMultiArgs["-buriedsfparams"].empty()) {
        ...
        buriedDeployments.insert(std::make_pair("bip65", Consensus::BuriedDeploymentPos::BIP65_HEIGHT_ACTIVE));
        buriedDeployments.insert(std::make_pair("bip66", Consensus::BuriedDeploymentPos::BIP66_HEIGHT_ACTIVE));
        ...
        for (auto i : deployments) {
            ...
            if (found == buriedDeployments.end()) {
                return InitError(strprintf("Invalid deployment (%s) (possible values are bip65, bip66)", vDeploymentParams[0]));
            }
